...
const UniversityGabes = () => {
  ...
  const filteredFaculties = Object.entries(universitiesData[13].Faculties).filter(
    ([facultyName, faculty]) => {
      if (searchBy === 'degree') {
  ...
  return (
    <>
      ...
      <section className="university-details">
        <h2>{universitiesData[13].university_name}</h2>
...
export default UniversityGabes;
