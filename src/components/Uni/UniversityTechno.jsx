...
const UniversityTechno = () => {
  ...
  const filteredFaculties = Object.entries(universitiesData[7].Faculties).filter(
    ([facultyName, faculty]) => {
      if (searchBy === 'degree') {
  ...
  return (
    <>
      ...
      <section className="university-details">
        <h2>{universitiesData[7].university_name}</h2>
...
export default UniversityTechno;
