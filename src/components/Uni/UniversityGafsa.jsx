...
const UniversityGafsa = () => {
  ...
  const filteredFaculties = Object.entries(universitiesData[5].Faculties).filter(
    ([facultyName, faculty]) => {
      if (searchBy === 'degree') {
  ...
  return (
    <>
      ...
      <section className="university-details">
        <h2>{universitiesData[5].university_name}</h2>
...
export default UniversityGafsa;
