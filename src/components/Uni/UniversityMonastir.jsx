...
const UniversityMonastir = () => {
  ...
  const filteredFaculties = Object.entries(universitiesData[2].Faculties).filter(
    ([facultyName, faculty]) => {
      if (searchBy === 'degree') {
  ...
  return (
    <>
      ...
      <section className="university-details">
        <h2>{universitiesData[2].university_name}</h2>
...
export default UniversityMonastir;
