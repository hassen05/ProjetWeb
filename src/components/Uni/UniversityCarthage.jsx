...
const UniversityCarthage = () => {
  ...
  const filteredFaculties = Object.entries(universitiesData[3].Faculties).filter(
    ([facultyName, faculty]) => {
      if (searchBy === 'degree') {
  ...
  return (
    <>
      ...
      <section className="university-details">
        <h2>{universitiesData[3].university_name}</h2>
...
export default UniversityCarthage;
