...
const UniversityKairouan = () => {
  ...
  const filteredFaculties = Object.entries(universitiesData[11].Faculties).filter(
    ([facultyName, faculty]) => {
      if (searchBy === 'degree') {
  ...
  return (
    <>
      ...
      <section className="university-details">
        <h2>{universitiesData[11].university_name}</h2>
...
export default UniversityKairouan;
