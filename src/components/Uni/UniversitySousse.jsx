...
const UniversitySousse = () => {
  ...
  const filteredFaculties = Object.entries(universitiesData[6].Faculties).filter(
    ([facultyName, faculty]) => {
      if (searchBy === 'degree') {
  ...
  return (
    <>
      ...
      <section className="university-details">
        <h2>{universitiesData[6].university_name}</h2>
...
export default UniversitySousse;
