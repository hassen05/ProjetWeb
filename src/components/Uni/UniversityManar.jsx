...
const UniversityManar = () => {
  ...
  const filteredFaculties = Object.entries(universitiesData[4].Faculties).filter(
    ([facultyName, faculty]) => {
      if (searchBy === 'degree') {
  ...
  return (
    <>
      ...
      <section className="university-details">
        <h2>{universitiesData[4].university_name}</h2>
...
export default UniversityManar;
