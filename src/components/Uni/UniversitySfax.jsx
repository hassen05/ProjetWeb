...
const UniversitySfax = () => {
  ...
  const filteredFaculties = Object.entries(universitiesData[8].Faculties).filter(
    ([facultyName, faculty]) => {
      if (searchBy === 'degree') {
  ...
  return (
    <>
      ...
      <section className="university-details">
        <h2>{universitiesData[8].university_name}</h2>
